<div class="container-fluid position-absolute">
  <div class="row no-gutter">
    <div class="d-none d-lg-flex col-lg-6 p-0 login-background">
      <img class="w-100 vh-100" src="<?= base_url('assets/img/fondo.png') ?>">
    </div>
          ...
          <div class="row">
            ...
            <div id="contentLogin" class="col-12 col-md-10 col-xl-7 mx-auto">
              <div class="text-center">
                <img class="w-50 mb-5" src="<?= base_url('assets/img/logo-negro-bloque.png')?>">
              </div>
              <form id="formLogin" autocomplete="off">
                <div class="form-label-group form-valid">
                  <input id="usuario" name="usuario" type="text" value="" class="form-control" placeholder="Usuario" required autocomplete="off">
