<div class="card">
  <div class="card-header">
    <div class="row justify-content-between">
      ...
      <?php if (validPermissions([911], true)) { ?>
...
<div class="modal fade modalFormulario" id="modalPaises" data-backdrop="static" data-keyboard="false" aria-labelledby="modalPaisesLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalPaisesLabel"></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="formPais" class="formValid">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-success" form="formPais"><i class="fas fa-save"></i> Guardar</button>
