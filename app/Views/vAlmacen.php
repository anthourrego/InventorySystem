...
<div class="modal fade modalFormulario" id="modalAlmacenes" data-backdrop="static" data-keyboard="false" aria-labelledby="modalAlmacenesLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalAlmacenesLabel"></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="formAlmacenes" class="formValid">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-success" form="formAlmacenes"><i class="fas fa-save"></i> Guardar</button>
